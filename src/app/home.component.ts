...
@Component({
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          ...
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">FluentFit stands out as the ultimate tool to help non-native English speakers confidently navigate interviews with native English speakers. Here’s why FluentFit is your perfect companion for interview success:</p>
      </div>
